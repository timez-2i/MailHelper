...
namespace MailHelper
{
    ...
    public class NcpMailer : Mailer
    {
        ...
        // SendProcess 재작성
        protected override string SendProcess(string email, string subject, string body)
        {
        ...
        #region
        // 내용 만들기
        private string GetContent(string email, string subject, string body)
        {
        ...
        // 수신자 목록
        private List<CRecipient> GetRecipients(string email)
        {
