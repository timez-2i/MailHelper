...
namespace MailHelperNet5
{
    ...
    public class Mailer
    {
        public event Action<Dictionary<string, string>, string, string, string> Success; // 메일 성공시 추가 동작, Ex) 로그 남기기
        public event Action<Dictionary<string, string>, string, string, Exception> Fail; // 메일 실패시 추가 동작, Ex) 로그 남기기
